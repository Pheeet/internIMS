...
import { AlertCircle, ChevronDown, Check, CalendarIcon, LockKeyhole } from "lucide-react";
import {
  Listbox,
  ListboxButton,
  ListboxOption,
    ...
    try {
      ...
      if (result?.success) {
        ...
        if (result.redirectUrl) {
          // Use window.location.href for a hard redirect to ensure middleware picks up the new state
            ...
            <div className="md:w-2/3 grid grid-cols-1 md:grid-cols-4 gap-x-6 gap-y-5 content-start">
              ...
              <div className="md:col-span-4 flex flex-col md:flex-row gap-x-6 gap-y-5">
                ...
                <div className="md:w-1/4">
                  ...
                  <Listbox name="prefix" value={prefix} onChange={setPrefix}>
                    <div className="relative">
                      <ListboxButton className="w-full flex items-center justify-between rounded-md border border-gray-200 bg-white px-3 py-2.5 text-sm text-left outline-none focus:border-[#F26522] focus:ring-1 focus:ring-[#F26522] data-[open]:border-[#F26522] data-[open]:ring-1 data-[open]:ring-[#F26522]">
                ...
                <div className="flex-1">
                  ...
                  <input
                    ...
                    className="w-full rounded-md border border-gray-200 bg-white px-3 py-2.5 text-sm text-gray-900 outline-none focus:border-[#F26522] focus:ring-1 focus:ring-[#F26522] placeholder-gray-400"
                  />
                </div>
                ...
                <div className="flex-1">
                  ...
                  <input
                    ...
                    className="w-full rounded-md border border-gray-200 bg-white px-4 py-2.5 text-sm text-gray-900 outline-none focus:border-[#F26522] focus:ring-1 focus:ring-[#F26522] placeholder-gray-400"
                  />
                </div>
              </div>
              ...
              <div className="md:col-span-2">
                ...
                <Listbox name="gender" value={gender} onChange={setGender}>
                  <div className="relative">
                    <ListboxButton className="w-full flex items-center justify-between rounded-md border border-gray-200 bg-white px-4 py-2.5 text-sm text-left outline-none focus:border-[#F26522] focus:ring-1 focus:ring-[#F26522] data-[open]:border-[#F26522] data-[open]:ring-1 data-[open]:ring-[#F26522]">
              ...
              <div className="md:col-span-2">
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    <button
                      type="button"
                      className="w-full flex items-center justify-between rounded-md border border-gray-200 bg-white px-4 py-2.5 text-sm text-gray-900 outline-none focus:border-[#F26522] focus:ring-1 focus:ring-[#F26522] text-left"
                    >
          ...
          <div className="flex flex-col gap-y-5 w-full mt-2">
            ...
            <div className="w-full">
              ...
              <textarea
                ...
                className="w-full resize-none rounded-md border border-gray-200 bg-white px-4 py-3 text-sm text-gray-900 outline-none focus:border-[#F26522] focus:ring-1 focus:ring-[#F26522] placeholder-gray-400"
              />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Listbox name="guardianRelationship" value={guardianRelationship} onChange={setGuardianRelationship}>
                  <div className="relative">
                    <ListboxButton className="w-full flex items-center justify-between rounded-md border border-gray-200 bg-white px-4 py-2.5 text-sm text-left outline-none focus:border-[#F26522] focus:ring-1 focus:ring-[#F26522] data-[open]:border-[#F26522] data-[open]:ring-1 data-[open]:ring-[#F26522]">
            ...
            <div className="flex justify-between items-center gap-4 mt-2">
              <Link
                href="/intern/change-password"
                className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-600 rounded-md border border-gray-300 hover:bg-gray-100 transition-colors"
              >
                <LockKeyhole size={15} />
                เปลี่ยนรหัสผ่าน
              </Link>
