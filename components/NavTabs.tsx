...
const studentTabs: NavTab[] = [
  { label: "แดชบอร์ด", href: "/intern/student" },
  { label: "ข้อมูลส่วนตัว", href: "/intern/student/profile" },
  { label: "การฝึกงาน", href: "/intern/student/internship-form" },
];

const adminTabs: NavTab[] = [
  { label: "แดชบอร์ด", href: "/intern/admin" },
  { label: "การฝึกงาน", href: "/intern/admin/internships" },
  { label: "บันทึกกิจกรรม", href: "/intern/admin/activities" },
