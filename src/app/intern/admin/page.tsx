...
export default async function AdminDashboardPage() {
  ...
  const activities = recentActivities.map((act) => {
    ...
    const at = act.actionType;
    if (["SUBMIT", "RESUBMIT", "APPROVE_DOC", "SUBMIT_DOC", "APPROVE_LEAVE", "SUBMIT_LEAVE"].includes(at)) toneColor = "green";
    else if (["FLAG_FIELDS", "DELETE_DOC", "REJECT_LEAVE"].includes(at)) toneColor = "red";
    ...
    else if (at === "STATUS_CHANGED") toneColor = "green"; // Default for status change
